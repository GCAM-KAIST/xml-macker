...
extension NSToolbarItem.Identifier {
    static let open      = NSToolbarItem.Identifier("xmleditorx.open")
    static let save      = NSToolbarItem.Identifier("xmleditorx.save")
    static let close     = NSToolbarItem.Identifier("xmleditorx.close")
    static let undo      = NSToolbarItem.Identifier("xmleditorx.undo")
    static let redo      = NSToolbarItem.Identifier("xmleditorx.redo")
    static let find      = NSToolbarItem.Identifier("xmleditorx.find")
    static let drillUp   = NSToolbarItem.Identifier("xmleditorx.drillUp")
    static let drillDown = NSToolbarItem.Identifier("xmleditorx.drillDown")
    static let orbit     = NSToolbarItem.Identifier("xmleditorx.orbit")
    static let diff      = NSToolbarItem.Identifier("xmleditorx.diff")
    static let workspace = NSToolbarItem.Identifier("xmleditorx.workspace")
    static let quickSearch = NSToolbarItem.Identifier("xmleditorx.quickSearch")
    static let marker      = NSToolbarItem.Identifier("xmleditorx.marker")
    static let markerJump  = NSToolbarItem.Identifier("xmleditorx.markerJump")
}
